...
% が，他の温度や湿度といった他の環境情報も技術的困難なしに提供できる．
...
%% {\tt Raspberry\-Com*PoTE} が提供する機能を用いて
...
%%上述の方針に基づいて設計実装した {\tt Raspberry\-Com*PoTE} の
...
\vspace*{-5zh}
\begin{figure}[h]
\centering%% \includegraphics[width=5cm]{figspics/henoheno.png}
...
\noindent{\large{\textgt{\textbf{・環境情報提供サーバの時刻提供機能}}}} \par
%% \vspace{0.5zh}
...
\noindent{\large{\textgt{\textbf{・環境情報提供サーバが提供する時刻との同期方法}}}} \par
%% \vspace{0.5zh}
...
%% \includegraphics[width=6.5cm]{figspics/RaspberryWorkbench2.jpg}

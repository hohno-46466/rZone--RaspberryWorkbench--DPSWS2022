...
{\tt Raspberry\-Workbench} の初期型は，2019年末頃から国内で開催されたものづくり愛好者のイベントで何度か図\ref{RaspberryWorkbench}のような動態展示を行なっている．今回の DPSワークショップ2022 のポスター・デモセッションでのデモはこれに準じた展示を行う．

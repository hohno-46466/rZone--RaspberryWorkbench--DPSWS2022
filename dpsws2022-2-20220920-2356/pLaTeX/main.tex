...
\includegraphics[width=8cm]{figspics/RaspberryComPoTE_figY.png}
...
{\tt Raspberry\-Workbench} の初期型は，2019年末頃から国内で開催されたものづくり愛好者のイベントで何度か図\ref{RaspberryWorkbench}のような動態展示を実施した．
今回の DPSワークショップ2022 のポスター・デモセッションでのデモではこれに準じた動態展示を行う．
